...
# Remark: Overall, you've really tested thoroughly here. Great!
# However, try to put tests in a more digestible format such that it's easy
# to see what they're testing. It's an indication that there's room for 
# improvement if a lot of set up is required, or if the test
# function itself has a complex structure.
...
class TestConnect4(unittest.TestCase):
    ...
    def test_move(self):
        ...
        # Remark: Try to avoid loops and conditionals in tests. You generally don't want too much complexity in tests,
        #  because that makes them complicated to understand and change. If you can't state what you want to test in a 
        # concise manner, most likely there is something to improve.
        # Also, you run into the danger that you're reimplementing the code you're testing in the test itself.
